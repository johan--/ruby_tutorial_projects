...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-api.com'
  config.app_name = 'Volt_api'
  config.mailer.from = 'Volt_api <no-reply@volt-api.com>'
  ...
  #
  config.app_secret = 'KAXS3B-_8K5Nln4BIx5pG7BEoieZhT_xEzbu4-IaS3bQFOo-axTXAo8cAdNyPDRCR2I'
