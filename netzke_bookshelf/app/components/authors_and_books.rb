class AuthorsAndBooks < Netzke::Basepack::Viewport
  ...
  component :books do |c|
    ...
    # Filter books data by author (component_session is simply the session store
    # scope out to the AuthorsAndBooks component, and is set in the endpoint
    # call below)
  ...
  endpoint :server_set_author do |params, this|
    # params[:author_id] comes from the client side of the component (see the
